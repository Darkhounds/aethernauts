...
var PongRoute = require('./../../mockups/route/commands/pong-route.mock');
var AuthenticationRoute = require('./../../mockups/route/commands/authentication-route.mock');
var ReconnectionRoute = require('./../../mockups/route/commands/reconnection-route.mock');
var UnknownRoute = require('./../../mockups/route/commands/unknown-route.mock');
...
describe('The Commands Router class', function () {
	...
	beforeEach(function () {
		...
		CommandsRouter = require('./../../../../src/server/route/commands-router');
	});
